...
This shows where he went during the entire length of his service in the Army, which took him across the US and Italy, with a vacation into Switzerland (not shown).
```{r}
make_map()
